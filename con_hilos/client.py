"""
Cliente TCP para servidor con hilos - Laboratorio 2
...
def mostrar_menu():
    ...
    print("(Servidor con hilos - Múltiples clientes)")
    print("="*50)
...
def agregar_calificacion():
    ...
    print("\nNRCs disponibles: MAT101, MAT102, FIS101, FIS102, QUI101, PRG101, PRG102, BDD101, RED101, SOP101")
    materia = input("NRC de la materia: ").upper()
...
def actualizar_calificacion():
    ...
    id_est = input("ID del estudiante: ")
    materia_actual = input("NRC de la materia actual: ").upper()
    calificacion = input("Nueva calificación: ")
    
    print("\n¿Desea cambiar el NRC de la materia? (s/n): ", end="")
    cambiar_nrc = input().lower()
    ...
    if cambiar_nrc == 's':
        print("NRCs disponibles: MAT101, MAT102, FIS101, FIS102, QUI101, PRG101, PRG102, BDD101, RED101, SOP101")
        datos_update["nueva_materia"] = input("Nuevo NRC: ").upper()
...
def main():
    ...
    HOST = '127.0.0.1'
    PORT = 5001  # Mismo puerto que el servidor con hilos
    ...
    try:
        ...
        print(f"[+] Conectado al servidor con hilos en {HOST}:{PORT}")
